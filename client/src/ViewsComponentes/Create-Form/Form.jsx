...
const Form = () => {
  ...
  const gendres = useSelector((state) => state.genres);
  ...
  const handleCheckGenres = (e) => {
    ...
    if (e.target.value) {
      setvalor({ ...valor, genres: [...valor.genres, e.target.value] });
    }
  };
  ...
  const handleClickGenres = (e) => {
    ...
    setvalor({
      ...valor,
      genres: valor.genres.filter((plant) => plant !== e.target.value),
    });
  };
